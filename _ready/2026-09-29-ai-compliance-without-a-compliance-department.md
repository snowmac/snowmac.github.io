---
layout: post
title: "AI Compliance for Businesses That Aren't Big Enough to Have a Compliance Department"
date: 2026-09-29
categories: AI Compliance HIPAA Small-Business
---
...
1. Find the vendor's data processing agreement or terms — not the marketing page, the legal one.
2. Check whether your inputs are used to train their models by default, and whether that can be turned off.
3. Check whether there's a business-tier agreement with real data commitments, versus the free consumer tier that usually has none.
4. If the answer to any of that is unclear or unavailable, that's your answer — don't put sensitive data into it.
